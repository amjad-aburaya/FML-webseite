<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="Go_Invist.about" %>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="probootstrap-animate">Go-Invest</h1>
                            <div class="probootstrap-subtitle probootstrap-animate">
                                <h2>
                                    Risks are always a problem, at Go-Invest we minimalize the risks when investing.
                                    <p>Our experiences in the stock market will guide you to a safe and profitable investment.</p>
                                </h2>
                            </div>
        ...
        <div class="container-fluid probootstrap-absolute">
            <div class="row">
                <div class="col-md-7 col-md-push-6 probootstrap-animate" data-animate-effect="fadeInRight">
                    <img src="img/victory.jpg" class="img-responsive shadow-left">
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-5 section-heading probootstrap-animate">
                    <h2>We aim high</h2>
                    <p class="lead">We are still a small company but we are aiming for a bigger and brighter future.Our consistent development will lead us to our target in a short time.</p>
        ...
        <div class="container-fluid probootstrap-absolute">
            <div class="row">
                <div class="col-md-8 col-md-pull-2 probootstrap-animate" data-animate-effect="fadeInLeft">
                    <img src="img/reviews.jpg" class="img-responsive">
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-5 col-md-push-6 section-heading probootstrap-animate">
                    ...
                    <figure class="probootstrap-quote-logo icon-mail">
                        <blockquote class="probootstrap-quote">
                            <p>"I just made my first 100 JOD from investing through you. Keep up the good work."<p>Isam Wadi, Jordan</p></p>
                        </blockquote>
                        <figure class="probootstrap-quote-logo icon-mail">
                            <blockquote class="probootstrap-quote">

                                <p>"I never knew anything about investing and I still don't,but with your services I made a few money in just two weeks!"</p>
                                <p>Becca James, Canada</p>
                            </blockquote>
                </div>
            </div>
        </div>
