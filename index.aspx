<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Go_Invist.index" %>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="probootstrap-animate">Invest in the stock market as never before</h1>
                            <div class="probootstrap-subtitle probootstrap-animate">
                                <h2>Our services provide a simple procedure for investing</h2>
                            </div>
            ...
            <div class="row mb70" style="margin-top: -120px;">
                <div class="col-md-4 probootstrap-animate">
                    <div class="probootstrap-box">
                        ...
                        <h3>Our Mission</h3>
                        <p>To take a stand for all investors, to treat them fairly, and to give them the best chance for investment success.</p>
                    </div>
                </div>
                <div class="col-md-4 probootstrap-animate">
                    <div class="probootstrap-box">
                        ...
                        <h3>Our Vision</h3>
                        <p>Ten years from now, we see that Go-Invest will be among the top 10 investment companies in the world. Where we will have more services to provide and still take no charge for our services.</p>
                    </div>
                </div>
                <div class="col-md-4 probootstrap-animate">
                    <div class="probootstrap-box">
                        ...
                        <h3>User Benefits</h3>
                        <p>Go-Invest includes all resources that you are looking for with a quick and clear result, with the addition that our services are completely free to use.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-md-offset-4 probootstrap-animate">
                    <p class="text-center">
                        <a class="btn btn-primary btn-lg btn-block"  role="button">Get started</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid probootstrap-absolute">
            <div class="row">
                <div class="col-md-7 col-md-push-6 probootstrap-animate" data-animate-effect="fadeInRight">
                    <img src="img/Stockgraph.jpeg" class="img-responsive shadow-left">
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-5 section-heading probootstrap-animate">
                    <h2>We guide Investors</h2>
                    <p class="lead">We will provide the best option for you to invest in based on your budget and the risk that you are willing to take. </p>
